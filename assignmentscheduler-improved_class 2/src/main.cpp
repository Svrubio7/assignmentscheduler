...
#include "assignmentcreator.hpp"  // For managing assignments
#include "planner.hpp"            // For planning the workweek
#include "displayfunctions.hpp"   // For displaying assignments
